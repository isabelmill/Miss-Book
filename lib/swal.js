! function (t, e) {
    ...
    function un(a, s, c) {
        return new Promise(function (t) {
            ...
            ge.swalPromiseResolve.set(a, t), s.confirmButton.onclick = function () {
                ...
                return e = c, (t = a).disableButtons(), void(e.returnInputValueOnDeny ? ze(t, e, "deny") : Ke(t, e, !1));
                var t, e
    ...
    var dn = function (t, e, n) {
            var o = V();
            rt(o), e.timer && (t.timeout = new Ae(function () {
    ...
    }), bn.DismissReason = Z, bn.version = "10.8.1";
    var wn = bn;
