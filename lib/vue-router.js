            ...
            listeners.forEach(listener => {
                listener(currentLocation.value, from, {
                    ...
                    direction: delta ?
                        ...
                        NavigationDirection.back : NavigationDirection.unknown,
                });
            });
        };
                ...
                for (const alias of aliases) {
                    normalizedRecords.push(assign({}, mainNormalizedRecord, {
                        ...
                        components: originalRecord ?
                            originalRecord.record.components : mainNormalizedRecord.components,
                        path: alias,
                        // we might be the child of an alias
                        aliasOf: originalRecord ?
                            originalRecord.record : mainNormalizedRecord,
    ...
    function stringifyQuery(query) {
        ...
        for (let key in query) {
            ...
            const values = Array.isArray(value) ?
                value.map(v => v && encodeQueryValue(v)) : [value && encodeQueryValue(value)];
            ...
            return () => {
                ...
                if (isBrowser &&
                    ...
                    const internalInstances = Array.isArray(component.ref) ?
                        component.ref.map(r => r.i) : [component.ref.i];
        ...
        function resolve(rawLocation, currentLocation) {
            ...
            return assign({
                ...
                query:
                    ...
                    normalizeQuery(rawLocation.query) : (rawLocation.query || {}),
            }, matchedRoute, {
                redirectedFrom: undefined,
                href,
            });
